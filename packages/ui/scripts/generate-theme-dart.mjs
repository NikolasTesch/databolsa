...
function schemeFor(mode) {
  ...
  const map = {
    ...
    onSurface: s.onSurface, onSurfaceVariant: s.onSurfaceVariant,
    surfaceDim: s.surfaceDim, surfaceBright: s.surfaceBright,
    ...
    tertiary: s.tertiary, tertiaryContainer: s.tertiaryContainer,
